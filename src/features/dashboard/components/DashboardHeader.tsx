  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      <div className="flex flex-col gap-1">
        <h1 className="text-4xl font-extrabold tracking-tight">Olá, {user?.name}!</h1>
      ...
      {isProvider && user?.slug && (
        <div className="flex items-center gap-3">
          <Button 
            ...
            className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-xl font-bold text-sm transition-all duration-200 cursor-pointer shadow-sm ${
              copied 
          ...
          <Button
            asChild
            variant="outline"
            className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 text-primary hover:bg-primary/20 px-4 py-2.5 rounded-xl font-bold text-sm transition-all duration-200 shadow-sm"
          >
            <a 
              href={`/${user.slug}`} 
              target="_blank" 
