...
export function ServiceSelector({ form }: ServiceSelectorProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h3 className="text-lg font-bold text-foreground">1. Selecione o Serviço</h3>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected
                  ? "border-[var(--brand-color)] bg-[var(--brand-color-light)] ring-1 ring-[var(--brand-color)]"
                  : "border-border hover:bg-accent/50 bg-card"
              )}
            >
