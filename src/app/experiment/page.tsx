    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 font-sans tracking-tight">
      ...
      <header className="sticky top-0 z-50 flex h-16 shrink-0 items-center justify-between border-b px-4 lg:px-8 bg-background/80 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium px-2 text-muted-foreground hidden md:inline">
            Tema:
          </span>
          <ThemeToggle />
        </div>
      ...
      <div className="flex">
        ...
        <aside className="w-64 hidden lg:flex flex-col sidebar-midnight h-[calc(100vh-4rem)] sticky top-16 p-4 gap-2">
          ...
          <a
            href="#"
            className="flex items-center gap-3 px-3 py-2 text-sm sidebar-item-active"
          >
        ...
        <main className="flex-1 p-6 md:p-10 lg:p-12 space-y-16 max-w-6xl mx-auto">
          ...
          <section className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
              Design System desenhado para focar em clareza no Light Mode e
              imersão tecnológica no Dark Mode. Teste os componentes abaixo
              simulando o ecossistema real do Agendify.
            </p>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4 items-center p-8 rounded-(--radius) border bg-card/40 midnight-shadow">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="card-midnight p-2">
                <CardHeader>
                  ...
                  <CardDescription>
                    Defina sua url de acesso público.
                  </CardDescription>
                </CardHeader>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <Input
                        ...
                        className="h-11 rounded-l-none input-midnight"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="h-11 input-midnight"
                    />
                  </div>
                </CardContent>
                <CardFooter>
                  <Button variant="midnight-primary" className="w-full">
                    Concluir Setup
                  </Button>
                </CardFooter>
              </Card>
              ...
              <div className="flex flex-col gap-4">
                <div className="p-6 rounded-(--radius) border border-primary/20 bg-accent/30 flex items-start gap-4">
                  <BellRing className="text-primary mt-1" size={20} />
                  <div>
                    <h4 className="font-medium">Dica de UX</h4>
                    <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
                      Inputs no tema Midnight usam <code>box-shadow</code>{" "}
                      interior sutil. O Focus Ring nativo foi removido em favor
                      de um border accent dramático, aumentando o conforto
                      visual.
                    </p>
                  </div>
                </div>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="card-midnight shadow-none border-primary/20 bg-accent/10">
                ...
                <CardContent>
                  <div className="text-lg font-medium text-foreground tracking-tight truncate">
                    agendify.com/joao
                  </div>
                  <Button
                    variant="midnight-ghost"
                    size="sm"
          ...
          <section className="space-y-6">
            ...
            <div className="max-w-xl p-8 rounded-[calc(var(--radius)+8px)] border bg-card midnight-shadow">
              ...
              <div className="mt-8 pt-6 border-t flex justify-end">
                <Button variant="midnight-primary" className="px-8">
                  Avançar
                </Button>
              </div>
            </div>
