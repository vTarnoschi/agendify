...
const tabsTriggerClass =
  "cursor-pointer font-semibold text-sm px-4 py-3 rounded-none border-none bg-transparent data-[state=active]:bg-transparent data-[state=active]:text-primary data-[state=active]:border-b-2 data-[state=active]:border-primary dark:data-[state=active]:bg-transparent text-muted-foreground hover:text-foreground";
    ...
    return (
      <div className="max-w-md mx-auto mt-20 text-center flex flex-col gap-4 animate-in fade-in duration-300">
        ...
        <p className="text-muted-foreground">
          Por favor, realize o login para acessar as configurações.
        </p>
      </div>
    );
  }

  const watchedBrandColor = visualForm.form.watch("brandColor") || "#18181b";
    ...
    <div className="flex flex-col gap-8 p-6 max-w-5xl mx-auto animate-in fade-in duration-300">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground font-medium">
          Gerencie seu expediente de trabalho, catálogo de serviços e
          personalize visualmente sua página pública.
        </p>
      </div>
      ...
      >
        ...
        >
          <TabsTrigger value="expediente" className={tabsTriggerClass}>
            <Clock className="h-4 w-4" aria-hidden="true" />
            <span>Expediente de Trabalho</span>
          </TabsTrigger>
          <TabsTrigger value="servicos" className={tabsTriggerClass}>
            <Sliders className="h-4 w-4" aria-hidden="true" />
            <span>Catálogo de Serviços</span>
          </TabsTrigger>
          <TabsTrigger value="visual" className={tabsTriggerClass}>
